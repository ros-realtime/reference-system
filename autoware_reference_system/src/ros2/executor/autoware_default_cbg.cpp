...
int main(int argc, char * argv[])
{
  ...
  {"PointCloudFusion", "RayGroundFilter", "ObjectCollisionEstimator"};
  ...
  auto euclidean_cluster_detector_node =
    std::dynamic_pointer_cast<nodes::rclcpp_system::Intersection>(
    find_node_or_fail(nodes, "EuclideanClusterDetector"));
  critpath_inner_executor.add_callback_group(
    euclidean_cluster_detector_node->get_callback_group_of_subscription(
      "/RayGroundFilter"),
    euclidean_cluster_detector_node->get_node_base_interface());
  other_executor.add_node(euclidean_cluster_detector_node->get_node_base_interface());
