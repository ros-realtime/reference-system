...
#ifndef REFERENCE_SYSTEM__NODES__RCLC_TRIGGER__TRANSFORM_HPP_
#define REFERENCE_SYSTEM__NODES__RCLC_TRIGGER__TRANSFORM_HPP_
#include <chrono>
#include <string>
#include <utility>
...
#endif  // REFERENCE_SYSTEM__NODES__RCLC_TRIGGER__TRANSFORM_HPP_
