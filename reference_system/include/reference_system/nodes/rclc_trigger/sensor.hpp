...
#ifndef REFERENCE_SYSTEM__NODES__RCLC_TRIGGER__SENSOR_HPP_
#define REFERENCE_SYSTEM__NODES__RCLC_TRIGGER__SENSOR_HPP_
#include <chrono>
#include <string>
#include <utility>
...
#endif  // REFERENCE_SYSTEM__NODES__RCLC_TRIGGER__SENSOR_HPP_
