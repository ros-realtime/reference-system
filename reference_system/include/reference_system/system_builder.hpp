...
#pragma GCC diagnostic ignored "-Wpedantic"
  ...
  nodes.emplace_back(std::make_shared<typename SystemType::Sensor>(
      SensorSettings{.node_name = "FrontLidarDriver",
                     ...
                     .cycle_time = SystemConfiguration::SENSOR_CYCLE_TIME}));
  ...
  // processing nodes
  nodes.emplace_back(
      std::make_shared<typename SystemType::Processing>(ProcessingSettings{
          .node_name = "PointsTransformerFront",
          .input_topic = "FrontLidarDriver",
          .output_topic = "PointsTransformerFront",
          .number_crunch_time =
              SystemConfiguration::PROCESSING_NODE_CRUNCH_TIME}));
  ...
  // fusion nodes
  nodes.emplace_back(
      std::make_shared<typename SystemType::Fusion>(FusionSettings{
          .node_name = "PointCloudFusion",
          .input_0 = "PointsTransformerFront",
          .input_1 = "PointsTransformerRear",
          .output_topic = "PointCloudFusion",
          .number_crunch_time = SystemConfiguration::FUSION_NODE_CRUNCH_TIME}));
  ...
  nodes.emplace_back(std::make_shared<typename SystemType::Reactor>(
      ReactorSettings{.node_name = "BehaviorPlanner",
                      ...
                      .number_crunch_time =
                          SystemConfiguration::REACTOR_NODE_CRUNCH_TIME}));
