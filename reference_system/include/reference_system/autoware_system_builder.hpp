...
#pragma GCC diagnostic ignored "-Wpedantic"
  ...
  // fusion nodes
  nodes.emplace_back(
      std::make_shared<typename SystemType::Fusion>(nodes::FusionSettings{
  ...
  // reactor node
  nodes.emplace_back(
      std::make_shared<typename SystemType::Reactor>(nodes::ReactorSettings{
  ...
  // command node
  nodes.emplace_back(
      std::make_shared<typename SystemType::Command>(nodes::CommandSettings{
